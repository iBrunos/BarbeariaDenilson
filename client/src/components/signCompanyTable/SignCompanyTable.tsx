      ...
      if (token) {
        ...
        if (userId) {
          ...
          try {
            ...
            const { email, ownerName } = response.data;
            ...
            <div className="grid grid-cols-1 gap-5 mt-4 sm:grid-cols-6">
              <div>
                ...
                <input
                  ...
                  type="text"
                  placeholder="Nome"
                  className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-white dark:text-gray-300 dark:border-gray-100 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
                  value={name}
              ...
              <div className="w-[10.8rem]">
                ...
                <input
                  id="emailAddress"
                  type="text"
                  className="block w-full px-1 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-white dark:text-gray-300 dark:border-gray-100 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
              ...
              <div className="ml-[2rem] w-[20rem] dark:bg-">
                ...
                <Select
                  ...
                  isMulti
                  options={options}
                  className="block w-full px-2 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-white dark:text-gray-300 dark:border-gray-100 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
              ...
              <div className="ml-10 w-[8rem]">
                <button type="submit" className="px-8 py-2.5 mt-8 leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
                  Salvar
                </button>
              </div>
            </div>
