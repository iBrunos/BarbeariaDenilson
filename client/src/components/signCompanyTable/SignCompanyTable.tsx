            ...
            <div className="grid grid-cols-1 gap-5 mt-4 sm:grid-cols-6">
              ...
              <div className="ml-[2rem] w-[20rem] dark:bg-">
                ...
                <Select
                  ...
                  isMulti
                  options={options}
                  className="block w-full px-2 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-white dark:text-black dark:border-gray-100 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
